...
// $sqlCheck = "SELECT staffNo FROM shipments WHERE awb = $AWB";
...
// if {
    ...
    mysqli_query($db, $sql) or die (header('location: https://dhltwilight-patrickking25.c9users.io/IndexHTML/CaptureNewShipment.php?error=Please enter AWB'));
